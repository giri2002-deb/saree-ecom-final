...
export default function Cart() {
  ...
  const handleCheckout = () => {
    if (state.items.length > 0) {
      navigate('/checkout', { state: { cartItems: state.items } });
    }
  };
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="flex-1 bg-black text-white py-3 px-6 font-medium hover:bg-gray-800 transition-colors duration-200"
              >
                PROCEED TO CHECKOUT
              </button>
            </div>
