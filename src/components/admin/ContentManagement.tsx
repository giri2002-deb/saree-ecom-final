...
import HeroSlideForm from './HeroSlideForm'; // ✅ Ensure the path is correct
import FeaturedForm from './FeturedForm';

interface ContentManagementProps {
  page: string;
}

export const ContentManagement: React.FC<ContentManagementProps> = ({ page }) => {
  const getPageTitle = () => {
    switch (page) {
      case 'home-banner':
        return 'Home Banner';
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-pink-50 to-rose-50 min-h-screen">
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-pink-500 to-rose-500 p-6 text-white flex items-center gap-3 rounded-t-xl">
